...
class Cell: BaseTableViewCell{
    ...
    override func setup() {
        ...
        lblplayer.leftAnchor.constraint(greaterThanOrEqualTo: leftAnchor, constant: 20).isActive = true
        // set kích thước tối thiểu cho label
        lblplayer.widthAnchor.constraint(greaterThanOrEqualToConstant: 100).isActive = true
        // neo dưới bottom
        lblplayer.bottomAnchor.constraint(equalTo: bottomAnchor, constant: -10).isActive = true
